...
Current generated surface: **13 headers** and **82 exported functions**.
...
- `common.h`: `skippy_feature`, `skippy_status`, `skippy_error`, `skippy_abi_version`, `SKIPPY_ABI_VERSION_MAJOR = 0`, `SKIPPY_ABI_VERSION_MINOR = 1`, `SKIPPY_ABI_VERSION_PATCH = 45`, `SKIPPY_FEATURE_RUNTIME_EVENT_REPORTER = ((uint64_t)1 << 29)`, `SKIPPY_FEATURE_MODEL_LOAD_EVENTS_V2 = ((uint64_t)1 << 30)`, `SKIPPY_FEATURE_KV_EVENTS = ((uint64_t)1 << 31)`, `SKIPPY_FEATURE_DEVICE_EVENTS = ((uint64_t)1 << 32)`, `SKIPPY_FEATURE_DIAGNOSTIC_EVENTS = ((uint64_t)1 << 33)`, `SKIPPY_FEATURE_UNLOAD_EVENTS = ((uint64_t)1 << 34)`
