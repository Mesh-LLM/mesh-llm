...
- Generated website artifact paths are `../docs/index.html`, `../docs/CNAME`, `../docs/install.sh`, `../docs/install.ps1`, `../docs/mesh-llm-logo.svg`, `../docs/assets/`, `../docs/catalog/`, `../docs/docs/`, and `../docs/pagefind/`.
...
- Eleventy passthrough copies `src/CNAME`, `src/assets/`, `src/mesh-llm-logo.svg`, and repo-root `../install.sh` / `../install.ps1` into the generated `docs/` tree.
