...
mod rotate_key_tests {
    ...
    struct HomeEnvGuard {
        ...
        // Redirects identity paths for this thread only; restored on drop. HOME
        // and MESH_LLM_NODE_KEY_PATH are unrelated process environment
        // requirements kept separate below.
