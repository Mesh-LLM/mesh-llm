...
#[cfg(test)]
use skippy_api::package::file_sha256;
...
pub use skippy_api::package::{SkippyPackageIdentity, SkippyPackageSourceFile};
use skippy_api::package::{
    package_v2_generation_info, package_v2_layer_weight_bytes, source_file, source_file_sha256,
};
...
fn synthetic_safetensors_package(
    ...
    source_paths.sort();
    source_paths.dedup();
    let digest_cache = hash_cache::open_default();
