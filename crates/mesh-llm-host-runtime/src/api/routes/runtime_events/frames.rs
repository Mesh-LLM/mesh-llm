...
pub(super) struct HealthProjection {
    ...
    pub(super) coalesced_progress: u64,
    ...
    pub(super) dropped_native: u64,
    pub(super) rejected_native: u64,
...
impl From<EngineHealthSnapshot> for HealthProjection {
    fn from(snapshot: EngineHealthSnapshot) -> Self {
        Self {
            ...
            coalesced_progress: snapshot.coalesced_progress,
            ...
            dropped_native: snapshot.dropped_native,
            rejected_native: snapshot.rejected_native,
