...
fn request_projection(
    ...
    Some(PublicRequest {
        ...
        caller_endpoint_id: metadata.caller_endpoint_id().map(str::to_owned),
        caller_addr: metadata.caller_addr().map(str::to_owned),
        caller_path_type: metadata.caller_path_type().map(str::to_owned),
