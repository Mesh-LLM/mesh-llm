...
// v15 combines main's v14 expansion of the fixed StageReplyStats payload from 23 to 27 i64 fields
// with per-stage prefill compute calibration fields. Stage peers must be upgraded together so
// older fixed-width reply readers reject the changed payload contract before decoding it.
