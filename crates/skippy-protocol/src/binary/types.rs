...
// v12 makes raw F32 the only activation wire representation, removes the dtype selector from the
// state header, and adds per-stage prefill compute calibration fields to reply statistics. Stage
