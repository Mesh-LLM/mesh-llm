...
impl QuantType {
    ...
    pub fn as_llama_file_type(self) -> skippy_ffi::LlamaFileType {
        match self {
            Self::Q1_0 => skippy_ffi::LlamaFileType::MostlyQ1_0,
            Self::Q2K => skippy_ffi::LlamaFileType::MostlyQ2K,
            Self::Q2KS => skippy_ffi::LlamaFileType::MostlyQ2KS,
            Self::Q3K | Self::Q3KM => skippy_ffi::LlamaFileType::MostlyQ3KM,
            Self::Q3KS => skippy_ffi::LlamaFileType::MostlyQ3KS,
            Self::Q3KL => skippy_ffi::LlamaFileType::MostlyQ3KL,
            Self::Q4_0 => skippy_ffi::LlamaFileType::MostlyQ4_0,
            Self::Q4_1 => skippy_ffi::LlamaFileType::MostlyQ4_1,
            Self::Q4K | Self::Q4KM => skippy_ffi::LlamaFileType::MostlyQ4KM,
            Self::Q4KS => skippy_ffi::LlamaFileType::MostlyQ4KS,
            Self::Q5_0 => skippy_ffi::LlamaFileType::MostlyQ5_0,
            Self::Q5_1 => skippy_ffi::LlamaFileType::MostlyQ5_1,
            Self::Q5K | Self::Q5KM => skippy_ffi::LlamaFileType::MostlyQ5KM,
            Self::Q5KS => skippy_ffi::LlamaFileType::MostlyQ5KS,
            Self::Q6K => skippy_ffi::LlamaFileType::MostlyQ6K,
            Self::Q8_0 => skippy_ffi::LlamaFileType::MostlyQ8_0,
            Self::IQ1S => skippy_ffi::LlamaFileType::MostlyIQ1S,
            Self::IQ1M => skippy_ffi::LlamaFileType::MostlyIQ1M,
            Self::IQ2XXS => skippy_ffi::LlamaFileType::MostlyIQ2XXS,
            Self::IQ2XS => skippy_ffi::LlamaFileType::MostlyIQ2XS,
            Self::IQ2S => skippy_ffi::LlamaFileType::MostlyIQ2S,
            Self::IQ2M => skippy_ffi::LlamaFileType::MostlyIQ2M,
            Self::IQ3XXS => skippy_ffi::LlamaFileType::MostlyIQ3XXS,
            Self::IQ3XS => skippy_ffi::LlamaFileType::MostlyIQ3XS,
            Self::IQ3S => skippy_ffi::LlamaFileType::MostlyIQ3S,
            Self::IQ3M => skippy_ffi::LlamaFileType::MostlyIQ3M,
            Self::IQ4NL => skippy_ffi::LlamaFileType::MostlyIQ4NL,
            Self::IQ4XS => skippy_ffi::LlamaFileType::MostlyIQ4XS,
...
impl TensorType {
    pub fn as_ggml_type(self) -> Option<skippy_ffi::GgmlType> {
        match self {
            Self::F32 => Some(skippy_ffi::GgmlType::F32),
            Self::F16 => Some(skippy_ffi::GgmlType::F16),
            Self::Q1_0 => Some(skippy_ffi::GgmlType::Q1_0),
            Self::Q4_0 => Some(skippy_ffi::GgmlType::Q4_0),
            Self::Q4_1 => Some(skippy_ffi::GgmlType::Q4_1),
            Self::Q5_0 => Some(skippy_ffi::GgmlType::Q5_0),
            Self::Q5_1 => Some(skippy_ffi::GgmlType::Q5_1),
            Self::Q8_0 => Some(skippy_ffi::GgmlType::Q8_0),
            Self::Q8_1 => Some(skippy_ffi::GgmlType::Q8_1),
            Self::Q2K => Some(skippy_ffi::GgmlType::Q2K),
            Self::Q3K => Some(skippy_ffi::GgmlType::Q3K),
            Self::Q4K => Some(skippy_ffi::GgmlType::Q4K),
            Self::Q5K => Some(skippy_ffi::GgmlType::Q5K),
            Self::Q6K => Some(skippy_ffi::GgmlType::Q6K),
            Self::Q8K => Some(skippy_ffi::GgmlType::Q8K),
            Self::IQ1S => Some(skippy_ffi::GgmlType::IQ1S),
            Self::IQ1M => Some(skippy_ffi::GgmlType::IQ1M),
            Self::IQ2XXS => Some(skippy_ffi::GgmlType::IQ2XXS),
            Self::IQ2XS => Some(skippy_ffi::GgmlType::IQ2XS),
            Self::IQ2S => Some(skippy_ffi::GgmlType::IQ2S),
            Self::IQ3XXS => Some(skippy_ffi::GgmlType::IQ3XXS),
            Self::IQ3S => Some(skippy_ffi::GgmlType::IQ3S),
            Self::IQ4NL => Some(skippy_ffi::GgmlType::IQ4NL),
            Self::IQ4XS => Some(skippy_ffi::GgmlType::IQ4XS),
            Self::I8 => Some(skippy_ffi::GgmlType::I8),
            Self::I16 => Some(skippy_ffi::GgmlType::I16),
            Self::I32 => Some(skippy_ffi::GgmlType::I32),
            Self::I64 => Some(skippy_ffi::GgmlType::I64),
            Self::F64 => Some(skippy_ffi::GgmlType::F64),
            Self::TQ1_0 => Some(skippy_ffi::GgmlType::TQ1_0),
            Self::TQ2_0 => Some(skippy_ffi::GgmlType::TQ2_0),
            Self::Mxfp4 => Some(skippy_ffi::GgmlType::Mxfp4),
            Self::Nvfp4 => Some(skippy_ffi::GgmlType::Nvfp4),
            Self::Bf16 => Some(skippy_ffi::GgmlType::Bf16),
        }
    }
