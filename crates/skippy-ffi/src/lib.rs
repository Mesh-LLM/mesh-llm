...
pub use dynamic::{
    ...
    llama_model_is_recurrent, llama_model_meta_val_str, llama_model_quantize,
    llama_model_quantize_default_params, load_native_runtime_libraries,
    load_native_runtime_library, mtmd_bitmap_free, mtmd_context_params_default,
    mtmd_decode_use_mrope, mtmd_default_marker, mtmd_free, mtmd_helper_bitmap_init_from_buf,
    mtmd_helper_eval_chunk_single, mtmd_helper_eval_chunks, mtmd_helper_get_n_pos,
...
pub use static_bindings::{
    ggml_log_set, llama_log_set, llama_model_is_diffusion, llama_model_is_hybrid,
    llama_model_is_recurrent, llama_model_meta_val_str, llama_model_quantize,
    llama_model_quantize_default_params, mtmd_bitmap_free, mtmd_context_params_default,
    mtmd_decode_use_mrope, mtmd_default_marker, mtmd_free, mtmd_helper_bitmap_init_from_buf,
    mtmd_helper_eval_chunk_single, mtmd_helper_eval_chunks, mtmd_helper_get_n_pos,
    mtmd_helper_get_n_tokens, mtmd_helper_image_get_decoder_pos, mtmd_helper_init_opt_default,
    mtmd_helper_log_set, mtmd_helper_video_free, mtmd_init_from_file,
