...
pub use abi::{
    ...
    FEATURE_DEVICE_EVENTS, FEATURE_DIAGNOSTIC_EVENTS, FEATURE_INKLING_MTP_MM,
    FEATURE_ITERATION_BATCH, FEATURE_KV_EVENTS, FEATURE_MODEL_LOAD_EVENTS_V2, FEATURE_MODEL_SOURCE,
