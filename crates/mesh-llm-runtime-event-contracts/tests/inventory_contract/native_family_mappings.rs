...
const KNOWN_FEATURE_BITS: [u32; 5] = [30, 31, 32, 33, 34];

/// Expected `(feature_bit, native_kind)` -> `event_id` rows, transcribed
/// from `third_party/llama.cpp/patches/0044-0048-skippy-add-*-events-
...
fn expected_rows() -> Vec<(u32, u32, &'static str)> {
    vec![
        (30, 100, "model_load_phase_changed"),
        (30, 101, "model_memory_allocation_summary"),
        (30, 102, "model_load_phase_changed"),
        (30, 103, "model_load_phase_changed"),
        (30, 104, "model_load_phase_changed"),
        (31, 200, "kv_cache_initialization_completed"),
        (31, 201, "cache_pressure_crossed"),
        (31, 202, "cache_pressure_cleared"),
        (31, 203, "context_capacity_approaching_limit"),
        (31, 204, "context_exhausted"),
        (32, 300, "backend_initialization_completed"),
        (32, 301, "device_ready"),
        (32, 302, "device_degraded"),
        (32, 303, "device_unavailable"),
        (32, 304, "device_recovered"),
        (32, 305, "device_lost"),
        (32, 306, "resource_allocation_completed"),
        (32, 307, "out_of_memory_condition"),
        (32, 308, "backend_fallback_activated"),
        (33, 400, "warning_raised"),
        (33, 401, "warning_cleared"),
        (33, 402, "recoverable_native_failure"),
        (33, 403, "fatal_native_failure"),
        (33, 404, "invariant_protocol_violation"),
        (34, 500, "unload_started"),
        (34, 501, "unload_completed"),
        (34, 502, "unload_failed"),
        (34, 503, "forced_unload"),
        (34, 504, "session_draining_started"),
    ]
}
...
fn every_row_is_scoped_to_a_known_feature_bit() {
    ...
    for row in &inventory.native_family_mappings {
        assert!(
            ...
            "native_family_mappings row for native_kind {} ({}) uses feature_bit {}, expected one of bits 30-34",
            row.native_kind,
            row.native_kind_name,
            row.feature_bit
        );
...
/// The acceptance-criterion assertion: every bit-30-34 native kind
/// (bit 29 itself, `RUNTIME_EVENT_REPORTER`, carries no kind catalog of its
...
#[test]
fn every_bit_30_to_34_native_kind_maps_to_exactly_one_inventory_id() {
    let inventory = load_inventory();
