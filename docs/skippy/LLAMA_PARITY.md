...
| `laguna` | `meshllm/laguna-s-2.1-Q4_K_M-layers@797f31cc813c0d643b7205118a901732f39de8ab` | package-backed `single-step` passed at split `24` | untested | untested | M5 Max f16 parity passed against pinned full-model revision `edd093522473dc7313b0738d8b4116b7f8b9745f`: baseline token `674` matched staged token `674`; width `3072`, 12,288-byte activation frame, 6,144-byte wire payload; chain, dtype matrix, state/cache, and mesh evidence remain pending |
