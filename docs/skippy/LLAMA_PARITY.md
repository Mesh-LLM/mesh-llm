...
| `laguna` | `meshllm/laguna-s-2.1-Q4_K_M-layers@797f31cc813c0d643b7205118a901732f39de8ab` | package validated | untested | untested | package-only validation passed: 48 layers; `0..24` and `24..48` stages materialized at 33,500,313,312 and 34,752,130,336 bytes |
