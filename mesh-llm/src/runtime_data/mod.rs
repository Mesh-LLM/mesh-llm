...
type RuntimeStatusUpdateFn = fn(&mut snapshots::RuntimeStatusSnapshot) -> bool;
type LocalProcessesUpdateFn = fn(&mut Vec<processes::RuntimeProcessSnapshot>) -> bool;

const _: fn(
    &collector::RuntimeDataCollector,
) -> tokio::sync::watch::Receiver<subscriptions::RuntimeDataSubscriptionState> =
    collector::RuntimeDataCollector::subscribe;
const _: fn(&collector::RuntimeDataCollector) -> subscriptions::RuntimeDataSubscriptionState =
    collector::RuntimeDataCollector::subscription_state;
const _: fn(&collector::RuntimeDataCollector) -> Vec<processes::RuntimeProcessSnapshot> =
    collector::RuntimeDataCollector::runtime_processes_snapshot;
const _: fn(&collector::RuntimeDataCollector) -> metrics::RuntimeLlamaRuntimeSnapshot =
    collector::RuntimeDataCollector::runtime_llama_snapshot;
const _: fn(&collector::RuntimeDataCollector) -> crate::network::metrics::RoutingCollectorSnapshot =
    collector::RuntimeDataCollector::routing_snapshot;
const _: fn(&crate::mesh::Node) -> crate::network::metrics::RoutingMetricsStatusSnapshot =
    crate::mesh::Node::routing_metrics_snapshot;
const _: fn(
    &crate::mesh::Node,
) -> std::collections::HashMap<
    String,
    crate::network::metrics::ModelRoutingMetricsSnapshot,
> = crate::mesh::Node::model_routing_metrics;
const _: fn(&collector::RuntimeDataCollector) -> crate::models::LocalModelInventorySnapshot =
    collector::RuntimeDataCollector::local_inventory_snapshot;
const _: fn(&collector::RuntimeDataCollector) -> snapshots::PluginDataSnapshot =
    collector::RuntimeDataCollector::plugin_data_snapshot;
const _: fn(&collector::RuntimeDataCollector) -> snapshots::PluginEndpointsSnapshot =
    collector::RuntimeDataCollector::plugin_endpoints_snapshot;
const _: fn(&collector::RuntimeDataCollector) -> plugins::PluginsSnapshotView =
    collector::RuntimeDataCollector::plugins_snapshot;
const _: fn(&collector::RuntimeDataCollector, &str) -> plugins::PluginScopedSnapshot =
    collector::RuntimeDataCollector::plugin_snapshot;
const _: fn(
    &collector::RuntimeDataCollector,
    &str,
    &str,
) -> Option<crate::plugin::PluginEndpointSummary> =
    collector::RuntimeDataCollector::plugin_endpoint_snapshot;
const _: fn(
    &collector::RuntimeDataCollector,
    snapshots::HardwareViewInput,
) -> snapshots::HardwareViewSnapshot = collector::RuntimeDataCollector::build_hardware_view;
const _: fn(
    &collector::RuntimeDataCollector,
    snapshots::StatusViewInput,
) -> snapshots::StatusViewSnapshot = collector::RuntimeDataCollector::build_status_view;
const _: fn(
    &collector::RuntimeDataCollector,
    snapshots::ModelViewInput,
) -> snapshots::ModelViewSnapshot = collector::RuntimeDataCollector::build_model_view;
const _: fn(snapshots::StatusViewSnapshot) -> crate::api::status::StatusPayload =
    api_views::status_payload;
const _: fn(snapshots::ModelViewSnapshot) -> Vec<crate::api::status::MeshModelPayload> =
    api_views::mesh_models;
const _: fn(
    &collector::RuntimeDataCollector,
    subscriptions::RuntimeDataDirty,
) -> subscriptions::RuntimeDataSubscriptionState = collector::RuntimeDataCollector::mark_dirty;
const _: fn(
    &collector::RuntimeDataCollector,
    Vec<crate::runtime::instance::LocalInstanceSnapshot>,
) -> bool = collector::RuntimeDataCollector::replace_local_instances_snapshot;
const _: fn(&collector::RuntimeDataCollector, metrics::RuntimeLlamaMetricsSnapshot) -> bool =
    collector::RuntimeDataCollector::replace_llama_metrics_snapshot;
const _: fn(&collector::RuntimeDataCollector, metrics::RuntimeLlamaSlotsSnapshot) -> bool =
    collector::RuntimeDataCollector::replace_llama_slots_snapshot;
const _: fn(
    &collector::RuntimeDataCollector,
    crate::network::metrics::RoutingCollectorSnapshot,
) -> bool = collector::RuntimeDataCollector::replace_routing_snapshot;
const _: fn(
    &collector::RuntimeDataCollector,
    snapshots::PluginDataKey,
    plugins::PluginDataValue,
) -> bool = collector::RuntimeDataCollector::publish_plugin_data;
const _: fn(
    &collector::RuntimeDataCollector,
    snapshots::PluginEndpointKey,
    crate::plugin::PluginEndpointSummary,
) -> bool = collector::RuntimeDataCollector::publish_plugin_endpoint;
const _: fn(&collector::RuntimeDataCollector, &str) -> bool =
    collector::RuntimeDataCollector::clear_plugin_reports;
const _: fn(
    &collector::RuntimeDataCollector,
    subscriptions::RuntimeDataDirty,
    RuntimeStatusUpdateFn,
) -> bool = collector::RuntimeDataCollector::update_runtime_status::<RuntimeStatusUpdateFn>;
const _: fn(&producers::RuntimeDataProducer) -> subscriptions::RuntimeDataSubscriptionState =
    producers::RuntimeDataProducer::mark_status_dirty;
const _: fn(&producers::RuntimeDataProducer) -> subscriptions::RuntimeDataSubscriptionState =
    producers::RuntimeDataProducer::mark_models_dirty;
const _: fn(&producers::RuntimeDataProducer) -> subscriptions::RuntimeDataSubscriptionState =
    producers::RuntimeDataProducer::mark_routing_dirty;
const _: fn(&producers::RuntimeDataProducer) -> subscriptions::RuntimeDataSubscriptionState =
    producers::RuntimeDataProducer::mark_processes_dirty;
const _: fn(&producers::RuntimeDataProducer) -> subscriptions::RuntimeDataSubscriptionState =
    producers::RuntimeDataProducer::mark_inventory_dirty;
const _: fn(&producers::RuntimeDataProducer) -> subscriptions::RuntimeDataSubscriptionState =
    producers::RuntimeDataProducer::mark_plugins_dirty;
const _: fn(&producers::RuntimeDataProducer) -> subscriptions::RuntimeDataSubscriptionState =
    producers::RuntimeDataProducer::mark_runtime_dirty;
const _: fn(&producers::RuntimeDataProducer, RuntimeStatusUpdateFn) -> bool =
    producers::RuntimeDataProducer::publish_runtime_status::<RuntimeStatusUpdateFn>;
const _: fn(&producers::RuntimeDataProducer, LocalProcessesUpdateFn) -> bool =
    producers::RuntimeDataProducer::publish_local_processes::<LocalProcessesUpdateFn>;
const _: fn(
    &producers::RuntimeDataProducer,
    crate::network::metrics::RoutingCollectorSnapshot,
) -> bool = producers::RuntimeDataProducer::publish_routing_snapshot;
const _: fn(&producers::RuntimeDataProducer, metrics::RuntimeLlamaMetricsSnapshot) -> bool =
    producers::RuntimeDataProducer::publish_llama_metrics_snapshot;
const _: fn(&producers::RuntimeDataProducer, metrics::RuntimeLlamaSlotsSnapshot) -> bool =
    producers::RuntimeDataProducer::publish_llama_slots_snapshot;
const _: fn(&producers::RuntimeDataProducer, crate::plugin::PluginSummary) -> bool =
    producers::RuntimeDataProducer::publish_plugin_summary;
const _: fn(&producers::RuntimeDataProducer, crate::plugin::PluginManifestOverview) -> bool =
    producers::RuntimeDataProducer::publish_plugin_manifest;
const _: fn(&producers::RuntimeDataProducer, Vec<crate::plugin::PluginCapabilityProvider>) -> bool =
    producers::RuntimeDataProducer::publish_plugin_providers;
const _: fn(&producers::RuntimeDataProducer, String, serde_json::Value) -> bool =
    producers::RuntimeDataProducer::publish_plugin_payload;
const _: fn(&producers::RuntimeDataProducer, crate::plugin::PluginEndpointSummary) -> bool =
    producers::RuntimeDataProducer::publish_plugin_endpoint;
const _: fn(&producers::RuntimeDataProducer, &str) -> bool =
    producers::RuntimeDataProducer::clear_plugin_reports;
const _: fn(
    &producers::RuntimeDataProducer,
    Vec<crate::runtime::instance::LocalInstanceSnapshot>,
) -> bool = producers::RuntimeDataProducer::replace_local_instances_snapshot;
const _: fn(&[processes::RuntimeProcessSnapshot]) -> Vec<crate::api::RuntimeProcessPayload> =
    processes::runtime_process_payloads;
const _: fn(
    &mut Vec<processes::RuntimeProcessSnapshot>,
    processes::RuntimeProcessSnapshot,
) -> bool = processes::upsert_runtime_process_snapshot;
const _: fn(&mut Vec<processes::RuntimeProcessSnapshot>, &str) -> bool =
    processes::remove_runtime_process_snapshot;
const _: fn(subscriptions::RuntimeDataVersion) -> u64 = subscriptions::RuntimeDataVersion::get;
const _: fn(subscriptions::RuntimeDataDirty) -> bool = subscriptions::RuntimeDataDirty::is_empty;
const _: fn(subscriptions::RuntimeDataDirty, subscriptions::RuntimeDataDirty) -> bool =
    subscriptions::RuntimeDataDirty::contains;
const _: subscriptions::RuntimeDataDirty = subscriptions::RuntimeDataDirty::STATUS;
const _: subscriptions::RuntimeDataDirty = subscriptions::RuntimeDataDirty::MODELS;
const _: subscriptions::RuntimeDataDirty = subscriptions::RuntimeDataDirty::ROUTING;
const _: subscriptions::RuntimeDataDirty = subscriptions::RuntimeDataDirty::PROCESSES;
const _: subscriptions::RuntimeDataDirty = subscriptions::RuntimeDataDirty::INVENTORY;
const _: subscriptions::RuntimeDataDirty = subscriptions::RuntimeDataDirty::PLUGINS;
const _: subscriptions::RuntimeDataDirty = subscriptions::RuntimeDataDirty::RUNTIME;
const _: fn(
    &subscriptions::RuntimeDataSubscriptions,
) -> tokio::sync::watch::Receiver<subscriptions::RuntimeDataSubscriptionState> =
    subscriptions::RuntimeDataSubscriptions::subscribe;
const _: fn(
    &subscriptions::RuntimeDataSubscriptions,
) -> subscriptions::RuntimeDataSubscriptionState = subscriptions::RuntimeDataSubscriptions::state;
const _: fn(
    &subscriptions::RuntimeDataSubscriptions,
    subscriptions::RuntimeDataDirty,
) -> subscriptions::RuntimeDataSubscriptionState = subscriptions::RuntimeDataSubscriptions::publish;
