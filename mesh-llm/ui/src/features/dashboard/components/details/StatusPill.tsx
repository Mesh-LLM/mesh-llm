  ...
  return (
    <Tooltip>
      <TooltipTrigger asChild>
        {/* eslint-disable-next-line jsx-a11y/prefer-button, jsx-a11y/prefer-tag-over-role -- span avoids nested button when StatusPill appears inside StatCard-like buttons */}
        <span
          role="button"
          tabIndex={0}
